...
# create 'x' data set by combining the train and test files
x_data <- rbind(x_train, x_test)

# create 'y' data set by combining the train and test files
y_data <- rbind(y_train, y_test)

# create 'subject' data set by combining the train and test files
